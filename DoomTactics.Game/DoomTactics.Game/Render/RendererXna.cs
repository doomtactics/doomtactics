...
namespace DoomTactics
{
    public class RendererXna : Squid.ISquidRenderer
    {
        ...
        public void Scissor(int x1, int y1, int x2, int y2)
        {
            ...
            if (x2 < x1 || y2 < y1)
                Game.GraphicsDevice.ScissorRectangle = new Rectangle(0, 0, 0, 0);
            else
                Game.GraphicsDevice.ScissorRectangle = new Rectangle(x1, y1, x2 - x1, y2 - y1);
        }
